...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={`border-b bg-slate-100 ${className || ""}`} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={`h-12 px-4 text-left align-middle font-medium text-slate-900 [&:has([role=checkbox])]:pr-0 ${className || ""}`}
    {...props}
  />
))
